...
class OculusReader:
    ...
    def stop(self):
        self.running = False
        # Best-effort: force-stop the running APK so it doesn't keep streaming logs in the background
        try:
            self.force_stop_app()
        except Exception:
            pass
    ...
    def force_stop_app(self):
        """Force-stop the teleoperation APK via adb.
        ...
        try:
            ...
            # Non-fatal; ignore if device not connected anymore
            pass
