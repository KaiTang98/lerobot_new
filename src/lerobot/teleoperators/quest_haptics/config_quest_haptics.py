...
@TeleoperatorConfig.register_subclass("bi_quest_haptics")
@dataclass(kw_only=True)
class BiQuestHapticsConfig(TeleoperatorConfig):
    """Configuration for bimanual Meta Quest teleoperation with haptics feedback.
